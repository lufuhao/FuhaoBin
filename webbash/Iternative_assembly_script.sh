...
### Source: https://github.com/cdb3ny/Mitochondrial-Genome-Scripts/blob/master/Iternative_assembly_script.sh
### PacBio-Based Mitochondrial Genome Assembly of Leucaena trichandra (Leguminosae) and an Intrageneric Assessment of Mitochondrial RNA Editing; Genome Biology and Evolution, Volume 10, Issue 9, September 2018, Pages 2501?2517, https://doi.org/10.1093/gbe/evy179

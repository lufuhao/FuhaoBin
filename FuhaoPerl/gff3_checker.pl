...
my ($success, $referenceids, $gene, $gene2mrna, $mrnas, $exons, $cds, $utr)=ReadGff3($inputgff3, $dbfasta);
unless ($success) {
	die "Error: ReadGff3 failed\n";
}

unless (WriteGff3($outputgff3, $referenceids, $gene2mrna, $gene, $mrnas, $exons, $cds, $utr)) {
